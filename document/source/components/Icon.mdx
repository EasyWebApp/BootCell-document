        ...
        {[
            {
                group: 'Solid',
                weight: 900,
                code: '<Icon name="camera" />',
                example: <Icon name="camera" />
            },
            {
                group: 'Brands',
                weight: 400,
                code: '<Icon group="brands" name="font-awesome" />',
                example: <Icon group="brands" name="font-awesome" />
            },
            {
                group: 'Regular',
                weight: 400,
                code: '<Icon group="regular" name="camera" />'
            },
            {
                group: 'Light',
                weight: 300,
                code: '<Icon group="light" name="camera" />'
            },
            {
                group: 'Duotone',
                weight: 900,
                code: '<Icon group="duotone" name="camera" />'
            }
...
<Example className="fa-4x">
    ...
    {[90, 180, 270].map(rotate => (
        <Icon name="snowboarding" rotate={rotate} />
    ))}
    {['horizontal', 'vertical', 'both'].map(flip => (
        <Icon name="snowboarding" flip={flip} />
    ))}
</Example>
